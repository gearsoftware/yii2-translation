 ...
 */
class MessageSource extends \gearsoftware\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('core', 'ID'),
            'category' => Yii::t('core/translation', 'Category'),
            'message' => Yii::t('core/translation', 'Source Message'),
            'immutable' => Yii::t('core/translation', 'Immutable'),
        ];
    }
